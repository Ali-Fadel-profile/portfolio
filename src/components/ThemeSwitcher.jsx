...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="bg-soft-blue flex h-8 w-14 items-center justify-around rounded-full transition-colors duration-300 dark:bg-main">
      <button
      ...
      <button
        className={`${activeCircleStyles} ${
          theme === "dark" ? "bg-black" : "bg-soft-blue"
        }`}
        onClick={() => toggleTheme("dark")}
      >
        <svg
          className="dark:fill- fill-white"
          width="12"
          height="12"
          viewBox="0 0 12 12"
          fill="none"
